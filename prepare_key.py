...
def clean_key_and_pass():
    ...
    raw_key_str = f"{comment}\n{data}"
    
    # Base64-encode the raw key string. Tauri CLI private key files (*.key) are actually
    # base64-encoded representations of the raw 2-line minisign files.
    base64_key = base64.b64encode(raw_key_str.encode("utf-8")).decode("utf-8")
