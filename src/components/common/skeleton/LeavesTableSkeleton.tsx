          ...
          <thead className="bg-slate-955/60">
            {showNameColumn ? (
              <tr>
                ...
                <th className="px-6 py-3.5 text-center"><div className="h-3 w-10 bg-slate-800 rounded mx-auto"></div></th>
              ...
              <tr key={idx}>
                {showNameColumn ? (
                  <>
                    ...
                    <td className="px-6 py-4"><div className="h-4 w-16 bg-slate-800 rounded mx-auto font-mono"></div></td>
                    <td className="px-6 py-4"><div className="h-5 w-20 bg-slate-800 rounded-full mx-auto"></div></td>
