...
export function AdminLeaveApprovalModal({
  ...
  }, [groupedChutiRequests, profilesList, searchQuery, notificationTypeFilter]);
  ...
  }, [pendingReserveRequests, profilesList, searchQuery, notificationTypeFilter]);
  ...
  }, [pendingProfileRequests, searchQuery]);
  ...
  }, [pendingPasswordResetRequests, searchQuery]);
  ...
  }, [adminHolidayNotifications, searchQuery]);
      ...
      case 'holiday_response': {
        ...
        return (
          <div key={item.id} className="bg-slate-955/60 border border-slate-850 rounded-xl p-4 flex flex-col sm:flex-row justify-between gap-4 relative overflow-hidden">
            ...
            <div className="space-y-1 text-xs text-slate-355 font-medium pl-2">
              <div className="flex flex-wrap items-center gap-2 mb-1">
      ...
      case 'profile_change': {
        ...
        return (
          <div key={item.id} className="bg-slate-955/60 border border-slate-850 rounded-xl p-4 flex flex-col gap-4 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-[11px] pl-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-xl bg-slate-955/20 border border-slate-800/60 relative">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <label className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider">Filter Notification Type</label>
              <CustomSelect
